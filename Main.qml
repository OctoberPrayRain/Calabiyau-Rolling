...
ApplicationWindow {
    ...
    // --- 数据与状态保持不变 ---
    property var maps: ["88区", "404基地", "奥卡努斯", "柯西街区", "欧拉港口", "科斯迷特", "空间实验室", "风曳镇", "莱布伦城"]
    property var scissorsPool: ["明","拉薇","梅瑞狄斯","令","香奈美","艾卡","珐格兰丝","玛拉","星绘","奥黛丽","玛德蕾娜","绯莎","白墨","加拉蒂亚","汐"]
    property var pusPool: ["米雪儿李","信","心夏","伊薇特","芙拉薇娅","忧雾","蕾欧娜","千代","星绘","奥黛丽","玛德蕾娜","绯莎","白墨","加拉蒂亚","汐"]
